...
export interface OdometerProps {
  ...
  fontSize: number;
  color: string;
  // hububb: let the house face and weight replace the bundled defaults
  fontFamily?: string;
  fontWeight?: number;
}
  ...
  return (
    <div
      style={{
        ...
        alignItems: "baseline",
        fontSize,
        fontWeight: fontWeight ?? 800, // hububb
        color,
        fontFamily: fontFamily ?? MONO_FAMILY, // hububb
...
export function Odometer({ current, fontSize, color, fontFamily, fontWeight }: OdometerProps) {
  ...
  return (
    <OdometerColumns
      ...
      color={color}
      fps={fps}
      fontFamily={fontFamily} // hububb
      fontWeight={fontWeight} // hububb
    />
  );
}
