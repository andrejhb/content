  ...
  return (
    <section className="border-t border-border first:border-t-0">
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-6 flex items-center justify-center rounded-xl border border-dashed border-border bg-surface px-6 py-10">
...
export default function CockpitPage() {
  return (
    <div className="min-h-dvh">
      ...
      {/* Creatives hallway — the primary working surface */}
      <ZonePlaceholder
        eyebrow="Creatives"
        title="The hallway"
