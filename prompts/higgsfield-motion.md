...
- aspect ratio(s) and duration
- whether to seed from an existing creative's still
- model tier (default from config/video.json unless I say top tier)

Download the result into the creative's folder so it reviews and zips like everything else.
